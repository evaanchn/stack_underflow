...
public:
     ...
     */
    Button(const std::string& label, const std::string& filePath, const sf::Color& buttonColor, const sf::Vector2f& size, const sf::Vector2f& position, float radius, int cornerPoints, unsigned int labelSize, const sf::Color& labelColor);
...
private:
     ...
     */
    void createArc(sf::VertexArray& vertices, sf::Vector2f center, float radius, float startAngle, float endAngle, int points, const sf::Color& color);
     ...
     */
    void createRoundedRectangle(sf::VertexArray& vertices, sf::Vector2f position, sf::Vector2f size, float radius, int cornerPoints, const sf::Color& color);
     ...
     */
    void centerLabelInButton(const sf::Vector2f& position, const sf::Vector2f& buttonSize);
     ...
     */
    std::string truncateTextToFit(const std::string& text, const sf::Vector2f& buttonSize, unsigned int textSize);
};
